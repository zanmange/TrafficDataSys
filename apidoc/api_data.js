define({ "api": [
  ...
  },
  {
    ...
    "name": "Status",
    "group": "Helper",
    "description": "<p>Return TrafficDataSys status (isRecording, recordingId etc etc)</p>",
    "success": {
      "examples": [
        {
          "title": "Success Response:",
  ...
  },
  {
    "type": "get",
    "url": "/start",
    "title": "Start TrafficDataSys",
    "name": "Start",
    "group": "TrafficDataSys",
    "description": "<p>Start TrafficDataSys without loading the UI</p> <p>This will start the YOLO process on the video input stream</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
